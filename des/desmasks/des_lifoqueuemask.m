function varargout = des_lifoqueuemask(block, action, subaction)
% Copyright 2005-2006 The MathWorks, Inc.
% $Revision: 1.1.8.8 $ $Date: 2009/11/13 04:16:07 $
...
%*********************************************************************
case 'default',
    des_def_lifoqueuemask(block,mfilename);
...
if(strcmp(subaction,'noapply'))
 ...
 if(~strcmp(updateOpt,'0'))
     set_param(childName,'SubClassName','DES_LIFOQUEUE');
     return;
 end
