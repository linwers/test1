function varargout = des_priorityqueuemask(block, action, subaction)
% Copyright 2005-2006 The MathWorks, Inc.
% $Revision: 1.1.8.10 $ $Date: 2009/11/13 04:16:09 $
...
case 'init',
    ...
    MaskParamCheck{1} = struct('Numeric', {idxCapacity}, ...
                            'isValid',  {'IsInt'    }, ...
                            'inRange',  {[0 Inf]    });
    MaskParamCheck{2} = struct('CharString', {idxSortingAttributeName});
...
%*********************************************************************
case 'default',
    des_def_priorityqueuemask(block,mfilename);
...
return; % End of the 'function des_priorityqueuemask.m'
...
if(strcmp(subaction,'noapply'))
 ...
 if(~strcmp(updateOpt,'0'))
     set_param(childName,'SubClassName','DES_PRIORITYQUEUE');
     return;
 end
 ...
 set_param(childName,'SubClassName','DES_ZEROCAPACITYPRIORITYQUEUE');
 return;
...
% --- end of des_priorityqueuemask.m
