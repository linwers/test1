function y=des_figposition(x)
%DES_FIGPOSITION Positions figure window irrespective of the screen resolution
% Y=DES_FIGPOSITION(X) generates a vector the size of X. 
...
% $ Revision $ $Date: 2005/11/23 20:25:26 $
